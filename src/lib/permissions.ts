...
export const APP_PERMISSIONS = {
  ...
  ACOPIADORES_MANAGE: 'acopiadores.manage',
...
const ROLE_PERMISSIONS: Record<string, AppPermission[]> = {
  ...
  [APP_ROLES.ADMINISTRADOR_PLANTA]: [
    ...
    APP_PERMISSIONS.AGRICULTORES_MANAGE,
    APP_PERMISSIONS.MAESTROS_MANAGE,
    APP_PERMISSIONS.ACOPIADORES_MANAGE,
...
const ROUTE_PERMISSIONS: Record<string, AppPermission> = {
  ...
  [ROUTES.ACOPIADORES]: APP_PERMISSIONS.ACOPIADORES_MANAGE,
  ...
  [ROUTES.EMPAQUETADO_OPERACIONES]: APP_PERMISSIONS.LOTES_PROCESS,
